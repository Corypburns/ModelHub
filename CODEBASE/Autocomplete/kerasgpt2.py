...
MODEL_NAME = "gpt2"
MODEL_PATH = BASE_PATH / "MODELBASE" / "Text-Autocomplete" / MODEL_NAME
LOG_DIR = BASE_PATH / "OUTPUTS" / "Autocomplete" / "KerasGPT2"

DATE_TIME = dt.now().strftime("%y%m%d_%H%M%S")
FILE_NAME = f"log_{MODEL_NAME}_{DATE_TIME}.csv"
...
# === GPT-2 AUTOCOMPLETE LOOP ===
def run_inference(tokenizer, model, mode="CPU1", n_inferences = 1000):
    while True:
